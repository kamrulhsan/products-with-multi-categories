                        ...
                        <table id="data_table" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <img src="{{ asset('uploads/products/thumbnails/'. $value->thumbnail) }}" alt=""></td>
                                    <td>{{ $value->stock_qty }}</td>
                                    <td>{{ $value->sku }}</td>
                                    <td>
                                        <a href="{{ route('products.edit', $value->id) }}" class="edit text-primary icon-size">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{ route('products.destroy', $value->id) }}" method="POST" class="d-inline delete-form">
                                            @csrf
                                            @method('DELETE')
