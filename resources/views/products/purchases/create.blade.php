    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                            <form id="product_add" method="post" action="{{ route('product-purchases.store') }}" class="form-horizontal">
                                {{ csrf_field() }}
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group mt-3 quantity">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" name="quantity" class="form-control f-14" id="quantity" placeholder="Product quantity">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mt-3 total_amount">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" name="total_amount" class="form-control f-14" id="total_amount" placeholder="Total Price">
