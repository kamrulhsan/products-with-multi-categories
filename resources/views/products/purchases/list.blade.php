                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="{{ route('product-purchases.create') }}" class="btn btn-primary">
                        ...
                        <table id="data_table" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('product-purchases.edit', $value->id) }}" class="edit text-primary icon-size">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{ route('product-purchases.destroy', $value->id) }}" method="POST" class="d-inline delete-form">
                                            @csrf
                                            @method('DELETE')
